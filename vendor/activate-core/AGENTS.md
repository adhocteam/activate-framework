...
This project uses a four-tier hierarchy for AI agent guidance. See [ADR-001](https://github.com/adhocteam/activate-copilot/blob/main/docs/adrs/ADR-001-agent-instructions-skills-files.md) for details.
...
- `docs/logs/` - Version-controlled logs (good for team visibility)
